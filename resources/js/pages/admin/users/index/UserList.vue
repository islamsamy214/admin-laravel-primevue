                ...
                >
                    ...
                    <Column header="Image" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            ...
                            <img :src="slotProps.data.image_path" :alt="slotProps.data.image" class="shadow-2" width="100" />
                        </template>
                    </Column>
                    ...
                    <Column field="action" header="Action" headerStyle="min-width:10rem;" class="text-center">
                        <template #body="slotProps">
                            <span class="p-column-title text-center">Action</span>
